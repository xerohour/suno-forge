...
// Optimization: Extracted VALID_MUTATION_TYPES to a module-level Set to ensure O(1) lookup
// complexity and avoid the memory allocation overhead of re-creating the array on every invocation.
