 ...
 */
// Optimization: Removed async/Promise wrapper since all operations are purely synchronous.
// This eliminates the Promise state machine allocation overhead on a hot path.
