 ...
 */
// Optimization: buildPrompt is purely synchronous, so we remove the async keyword
// and Promise wrapper to avoid state machine overhead and object allocation.
