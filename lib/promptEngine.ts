 ...
 *
 * Performance note: This function is completely synchronous.
 * Removing the unnecessary Promise wrapper prevents useless
 * micro-task queuing and simplifies parallel batch creation.
 */
