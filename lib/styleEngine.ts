...
export function buildStyle(config: PromptDNA): string {
  ...
  // Optimization: For this very small fixed array, a single-pass loop with manual includes() check
  // is faster and allocates less memory than using Set objects and intermediate arrays.
