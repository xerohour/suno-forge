...
export function buildStyle(config: PromptDNA): string {
  ...
  // Optimization: Combines array filtering and deduplication into a single pass.
  // Uses an array to preserve order and a Set for O(1) lookups, eliminating intermediate array allocations and O(N) conversions.
