...
export function buildStyle(config: PromptDNA): string {
  ...
  // Optimization: For very small arrays, a single-pass loop with Array.prototype.includes()
  // avoids Set allocation and iterator overhead, providing significantly faster deduplication.
