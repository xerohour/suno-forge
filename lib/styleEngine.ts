...
export function buildStyle(config: PromptDNA): string {
  ...
  // Optimization: For strictly bounded arrays (under 10 items), O(N^2) `.includes()` lookup
  // is faster than O(1) Set lookup because it avoids object allocation overhead.
