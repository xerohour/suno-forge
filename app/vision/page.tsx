          ...
          >
            ...
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <button tabIndex={-1} className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full hover:scale-105 transition-transform pointer-events-none">
                  SELECT FILE
                </button>
                <input
                  type="file"
