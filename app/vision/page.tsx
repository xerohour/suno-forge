          ...
          >
            ...
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <span className="mt-2 inline-block bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full group-hover:scale-105 group-focus-visible:scale-105 transition-transform">
                  SELECT FILE
                </span>
                <input
                  type="file"
