        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              role="button"
              tabIndex={0}
              aria-label={description ? "Change Image" : "Select Image"}
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 transition-all duration-500 outline-none"
            ...
            >
              ...
              <div className="absolute inset-1 hexagon-border border border-primary/20 pointer-events-none group-focus-visible:border-primary group-focus-visible:ring-2 group-focus-visible:ring-primary group-focus-visible:ring-offset-2 group-focus-visible:ring-offset-background-dark transition-all"></div>
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <span className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full group-hover:scale-105 transition-transform">
                  SELECT FILE
                </span>
                <input
                  type="file"
