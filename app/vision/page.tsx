        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              role="button"
              tabIndex={0}
              aria-label="Upload visual inspiration"
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 transition-all duration-500 focus:outline-none"
              onClick={() => fileInputRef.current?.click()}
              onKeyDown={handleKeyDown}
            >
              {/* Inner Hexagon for Border Effect */}
              <div className="absolute inset-1 hexagon-border border border-primary/20 pointer-events-none group-focus-visible:border-primary group-focus-visible:border-4 transition-all"></div>
