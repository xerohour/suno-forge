        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              role="button"
              tabIndex={0}
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background transition-all duration-500"
