        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              role="button"
              tabIndex={0}
              aria-label={description ? "Change selected image" : "Upload image for vision analysis"}
              onKeyDown={(e) => {
            ...
            >
              ...
              <div className="absolute inset-1 hexagon-border border border-primary/20 pointer-events-none group-focus-visible:border-primary group-focus-visible:border-2 transition-colors"></div>
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <button tabIndex={-1} aria-hidden="true" className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full hover:scale-105 transition-transform">
                  SELECT FILE
                </button>
                <input
                  type="file"
