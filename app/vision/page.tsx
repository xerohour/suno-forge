          ...
          >
            ...
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                <div className="size-16 rounded-full bg-primary/20 flex items-center justify-center border border-primary shadow-[0_0_20px_rgba(13,242,242,0.4)] group-hover:scale-105 transition-transform">
