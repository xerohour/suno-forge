      ...
      <div className="relative flex min-h-screen w-full flex-col overflow-x-hidden max-w-md mx-auto border-x border-primary/10 bg-background-light dark:bg-background-dark shadow-2xl">
        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            {/* Hexagon Shape */}
            <div
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-background-dark transition-all duration-500"
              onClick={() => fileInputRef.current?.click()}
              onKeyDown={handleKeyDown}
              role="button"
              tabIndex={0}
              aria-label={description ? "Change selected image" : "Select an image file to upload"}
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4 pointer-events-none">
                ...
                <span className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full group-hover:scale-105 transition-transform inline-block">
                  SELECT FILE
                </span>
                <input
                  type="file"
