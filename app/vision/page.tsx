        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              role="button"
              tabIndex={0}
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 focus-visible:outline-none transition-all duration-500"
              ...
              aria-label="Upload visual inspiration image"
            >
              {/* Inner Hexagon for Border Effect */}
              <div className="absolute inset-1 hexagon-border border border-primary/20 group-focus-visible:border-primary group-focus-visible:border-2 pointer-events-none transition-colors"></div>

              <div className="z-10 flex flex-col items-center gap-4">
                <div className="size-16 rounded-full bg-primary/20 flex items-center justify-center border border-primary shadow-[0_0_20px_rgba(13,242,242,0.4)] group-focus-visible:bg-primary/40 group-focus-visible:shadow-[0_0_30px_rgba(13,242,242,0.8)] transition-all">
                ...
                <span className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full group-hover:scale-105 group-focus-visible:scale-105 transition-transform">
                  SELECT FILE
                </span>
                <input
                  type="file"
