          ...
          >
            ...
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <span className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full group-hover:scale-105 transition-transform flex items-center justify-center">
                  SELECT FILE
                </span>
                <input
                  type="file"
