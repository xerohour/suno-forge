        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-1 hexagon-border border border-primary/20 group-focus-visible:border-primary group-focus-visible:border-2 pointer-events-none"></div>
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <span className="mt-2 inline-block bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full hover:scale-105 transition-transform">
                  SELECT FILE
                </span>
                <input
                  type="file"
