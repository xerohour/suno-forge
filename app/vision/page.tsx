        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            >
              ...
              <div className="absolute inset-1 hexagon-border border border-primary/20 group-focus-visible:border-primary group-focus-visible:bg-primary/5 pointer-events-none transition-colors"></div>
