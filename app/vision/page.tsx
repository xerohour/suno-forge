        ...
        <main className="flex-1 px-6 flex flex-col items-center pb-32">
          ...
          >
            ...
            <div
              ...
              className="relative w-full h-full hexagon-border bg-primary/10 border border-primary/30 flex flex-col items-center justify-center group cursor-pointer hover:bg-primary/20 focus:outline-none transition-all duration-500"
            ...
            >
              ...
              <div className="z-10 flex flex-col items-center gap-4">
                ...
                <span className="mt-2 bg-primary text-background-dark text-xs font-bold py-2 px-4 rounded-full hover:scale-105 transition-transform inline-block">
                  SELECT FILE
                </span>
                <input
                  type="file"
